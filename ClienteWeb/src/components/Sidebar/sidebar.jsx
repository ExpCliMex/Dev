                ...
                <nav className="sidebar">
                    ...
                    <div className="sidebar-body">
                        <ul className="nav">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" data-bs-toggle="collapse" href="#calendarD" role="button" aria-expanded="false" aria-controls="calendarD">
                                ...
                                <div className="collapse" id="calendarD">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" data-bs-toggle="collapse" href="#pacientesDrop" role="button" aria-expanded="false" aria-controls="pacientesDrop">

                                    <FeatherIcon className="link-icon" icon="users" />
                                    <span className="link-title">Pacientes</span>
                                    <FeatherIcon className="link-arrow" icon="chevron-down" />
                                </a>
                                <div className="collapse" id="pacientesDrop">
                                    <ul className="nav sub-menu">
                                        <li className="nav-item">
                                            <NavLink className="nav-item nav-link" to="/pacienteTest">
                                                Buscar
                            ...
                            <li className="nav-item">
                                <a className="nav-link" data-bs-toggle="collapse" href="#adminDrop" role="button" aria-expanded="false" aria-controls="adminDrop">

                                    <FeatherIcon className="link-icon" icon="book" />
                                    <span className="link-title">Administrar</span>
                                    <FeatherIcon className="link-arrow" icon="chevron-down" />
                                </a>
                                <div className="collapse" id="adminDrop">
                                    <ul className="nav sub-menu">
                                        <li className="nav-item">
