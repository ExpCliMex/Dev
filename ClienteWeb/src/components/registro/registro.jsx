                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 ps-md-0">
                      <div class="auth-form-wrapper px-4 py-5">
                        ...
                        <h5 class="text-muted fw-normal mb-4">Crear cuenta.</h5>
                        <form onSubmit={handleSubmit(onSubmit)} class="forms-sample">
                          <div class="mb-3">
                            <label
                          ...
                          <a href="login.html" class="d-block mt-3 text-muted">
                          <NavLink
