...
export default function PatientTest() {
  //CARGAR DATOS desde un archivo de configuracion de formularios.
  //cargar por secciones
  //buscar los labels en el archivos de traducciones
  //configuracion del post etc etc
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div id="wizardVertical">
                        <h4 className="card-title">Informacion general del paciente</h4>
                        <section>
                          <div className="row">
                        ...
                        <h2 className="card-title">Contacto y domicilio de residencia</h2>
                        <section>
                          <Card>
                        ...
                        {/* inicia seccion 3 */}
                        <h2 className="card-title">Persona responsable del paciente</h2>
                        <section>
                          <Card>
                        ...
                        {/* termina seccion 3 */}
                        {/* inicia seccion 4 */}
                        <h2 className="card-title">Seguro médico</h2>
                        <section>
                          <Card>
                        ...
                        {/* termina seccion 4 */}
                        {/* inicia seccion 5 */}
                        <h2 className="card-title">Información laboral</h2>
                        <section>
                          <Card>
                        ...
                        {/* termina seccion 5 */}
                        {/* inicia seccion 6 */}
                        <h2 className="card-title">Información de facturación</h2>
                        <section>
                          <Card>
